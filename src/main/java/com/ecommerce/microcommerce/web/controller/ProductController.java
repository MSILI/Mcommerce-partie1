...
public class ProductController {
	...
	public MappingJacksonValue calculerMargeProduit() {
		...
		produits.forEach(product -> {
			porduitAvecMarge.put(product, product.getPrix() - product.getPrixAchat());
		});

		SimpleBeanPropertyFilter monFiltre = SimpleBeanPropertyFilter.serializeAllExcept("prixAchat");
		FilterProvider listDeNosFiltres = new SimpleFilterProvider().addFilter("monFiltreDynamique", monFiltre);
		MappingJacksonValue produitsFiltres = new MappingJacksonValue(porduitAvecMarge);
		produitsFiltres.setFilters(listDeNosFiltres);
	...
	public MappingJacksonValue  trierProduitsParOrdreAlphabetique() {
		...
		FilterProvider listDeNosFiltres = new SimpleFilterProvider().addFilter("monFiltreDynamique", monFiltre);
		MappingJacksonValue produitsFiltres = new MappingJacksonValue(listDesProduits);
		produitsFiltres.setFilters(listDeNosFiltres);
		return produitsFiltres;
	}
